  ...
  return (
    <Section bgColor="bg-light-green">
      <div className="w-screen h-screen bg-[rgb(55,64,95)] p-8 flex flex-col justify-center items-center">
        <div className="relative w-full h-full bg-gradient-to-r from-[rgb(232,214,255)] via-[rgb(217,221,232)] to-[rgb(233,237,248)] shadow-2xl rounded-lg flex flex-col justify-center items-center p-8">
          <div className="absolute top-40 w-full">
            <Navbar />
          </div>

          <motion.div
            className="absolute top-[20px] w-40 h-40 md:w-60 md:h-60 rounded-full border-4 border-white overflow-hidden shadow-xl z-20"
            initial={{ scale: 0.9 }}
            animate={{ scale: 1 }}
